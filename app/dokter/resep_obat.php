      ...
      <div id="page_top" class="section-white ">
        <div class="container-fluid">
          <div class="page-header">
            <div class="left">
              <h1 class="page-title">Resep Obat</h1>
            ...
            <div class="col-md-12">
              <div class="card">
                <div class="card-header">
                  <h3 class="card-title">Form Resep Obat</h3>
                </div>
                <div class="card-body">
                  <form id="basic-form" method="post" novalidate>
                    ...
                    <div class="form-group">
                      ...
                      <select class="form-control custom-select" name="ko">
                    ...
                    <div class="form-group">
                      <label>Jumlah</label>
                      <input type="number" class="form-control" required name="jumlah" autocomplete="off">
                    </div>
                    <div class="form-group">
